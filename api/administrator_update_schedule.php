...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .update-box { background: #e9ecef; border-radius: 8px; padding: 50px 40px; text-align: left; color: #555; max-width: 1000px; }
        .update-box p { font-size: 16px; margin-bottom: 30px; color: #333; }
        .btn-back { display: inline-block; background: #cccccc; color: #333; padding: 10px 35px; border-radius: 12px; text-decoration: none; font-size: 14px; font-weight: 600; border: none; cursor: pointer; }
        .btn-back:hover { background: #bbbbbb; }
        .form-box { background: #d9d9d9; padding: 25px; border-radius: 10px; max-width: 600px; }
        .form-box label { display: block; margin-bottom: 5px; font-weight: 600; color: #333; }
        ...
        .btn-row button, .btn-row a { padding: 10px 20px; border-radius: 10px; border: none; cursor: pointer; text-decoration: none; font-size: 14px; }
